...
const sc_lv<11> combinar::ap_const_lv11_401 = "10000000001";
...
combinar::combinar(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_and_ln106_fu_124_p2);
    sensitive << ( end_0_2_i_fu_42 );
    sensitive << ( end_1_2_i_fu_46 );
    ...
    sensitive << ( empty_n_reg_144 );
    sensitive << ( icmp_ln879_reg_162 );

    SC_METHOD(thread_ap_predicate_op38_write_state4);
    sensitive << ( empty_n_1_reg_153 );
    sensitive << ( icmp_ln879_1_reg_166 );

    SC_METHOD(thread_ap_ready);
    sensitive << ( result_V_V_full_n );
    sensitive << ( ap_CS_fsm_state5 );

    SC_METHOD(thread_empty_n_1_fu_88_p1);
    sensitive << ( in2b_V_V_read_nbread_fu_56_p2_0 );

    SC_METHOD(thread_empty_n_fu_80_p1);
    sensitive << ( in1b_V_V_read_nbread_fu_50_p2_0 );

    SC_METHOD(thread_icmp_ln879_1_fu_107_p2);
    sensitive << ( in2b_V_V_dout );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( empty_n_1_fu_88_p1 );

    SC_METHOD(thread_icmp_ln879_fu_96_p2);
    sensitive << ( in1b_V_V_dout );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( empty_n_fu_80_p1 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    ...
    SC_METHOD(thread_in1b_V_V_read_nbread_fu_50_p2_0);
    sensitive << ( in1b_V_V_empty_n );
    ...
    SC_METHOD(thread_in2b_V_V_read_nbread_fu_56_p2_0);
    sensitive << ( in2b_V_V_empty_n );
    ...
    sc_trace(mVcdFile, empty_n_reg_144, "empty_n_reg_144");
    sc_trace(mVcdFile, icmp_ln879_reg_162, "icmp_ln879_reg_162");
    sc_trace(mVcdFile, ap_CS_fsm_pp0_stage0, "ap_CS_fsm_pp0_stage0");
    sc_trace(mVcdFile, ap_enable_reg_pp0_iter1, "ap_enable_reg_pp0_iter1");
    sc_trace(mVcdFile, ap_block_pp0_stage0, "ap_block_pp0_stage0");
    sc_trace(mVcdFile, empty_n_1_reg_153, "empty_n_1_reg_153");
    sc_trace(mVcdFile, icmp_ln879_1_reg_166, "icmp_ln879_1_reg_166");
    sc_trace(mVcdFile, ap_CS_fsm_state5, "ap_CS_fsm_state5");
    sc_trace(mVcdFile, empty_n_fu_80_p1, "empty_n_fu_80_p1");
    ...
    sc_trace(mVcdFile, empty_n_1_fu_88_p1, "empty_n_1_fu_88_p1");
    sc_trace(mVcdFile, tmp_V_2_reg_157, "tmp_V_2_reg_157");
    sc_trace(mVcdFile, icmp_ln879_fu_96_p2, "icmp_ln879_fu_96_p2");
    sc_trace(mVcdFile, icmp_ln879_1_fu_107_p2, "icmp_ln879_1_fu_107_p2");
    sc_trace(mVcdFile, and_ln106_fu_124_p2, "and_ln106_fu_124_p2");
    ...
    sc_trace(mVcdFile, end_0_2_i_fu_42, "end_0_2_i_fu_42");
    sc_trace(mVcdFile, end_1_2_i_fu_46, "end_1_2_i_fu_46");
    sc_trace(mVcdFile, in1b_V_V_read_nbread_fu_50_p2_0, "in1b_V_V_read_nbread_fu_50_p2_0");
    sc_trace(mVcdFile, in2b_V_V_read_nbread_fu_56_p2_0, "in2b_V_V_read_nbread_fu_56_p2_0");
...
void combinar::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
             ...
             esl_seteq<1,1,1>(ap_const_lv1_1, and_ln106_fu_124_p2.read()))) {
            ap_enable_reg_pp0_iter0 = ap_const_logic_0;
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_1, empty_n_fu_80_p1.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln879_fu_96_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_lv1_1, empty_n_1_fu_88_p1.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln879_1_fu_107_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        empty_n_1_reg_153 = in2b_V_V_read_nbread_fu_56_p2_0.read();
        empty_n_reg_144 = in1b_V_V_read_nbread_fu_50_p2_0.read();
        tmp_V_2_reg_157 = in2b_V_V_dout.read();
        tmp_V_reg_148 = in1b_V_V_dout.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, empty_n_1_fu_88_p1.read()))) {
        icmp_ln879_1_reg_166 = icmp_ln879_1_fu_107_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, empty_n_fu_80_p1.read()))) {
        icmp_ln879_reg_162 = icmp_ln879_fu_96_p2.read();
    }
}

void combinar::thread_and_ln106_fu_124_p2() {
    and_ln106_fu_124_p2 = (end_0_2_i_fu_42.read() & end_1_2_i_fu_46.read());
}
...
void combinar::thread_ap_predicate_op29_write_state3() {
    ap_predicate_op29_write_state3 = (esl_seteq<1,1,1>(empty_n_reg_144.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(icmp_ln879_reg_162.read(), ap_const_lv1_0));
}

void combinar::thread_ap_predicate_op38_write_state4() {
    ap_predicate_op38_write_state4 = (esl_seteq<1,1,1>(ap_const_lv1_1, empty_n_1_reg_153.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln879_1_reg_166.read()));
}
...
void combinar::thread_empty_n_1_fu_88_p1() {
    empty_n_1_fu_88_p1 = in2b_V_V_read_nbread_fu_56_p2_0.read();
}

void combinar::thread_empty_n_fu_80_p1() {
    empty_n_fu_80_p1 = in1b_V_V_read_nbread_fu_50_p2_0.read();
}

void combinar::thread_icmp_ln879_1_fu_107_p2() {
    icmp_ln879_1_fu_107_p2 = (!in2b_V_V_dout.read().is_01() || !ap_const_lv11_401.is_01())? sc_lv<1>(): sc_lv<1>(in2b_V_V_dout.read() == ap_const_lv11_401);
}

void combinar::thread_icmp_ln879_fu_96_p2() {
    icmp_ln879_fu_96_p2 = (!in1b_V_V_dout.read().is_01() || !ap_const_lv11_401.is_01())? sc_lv<1>(): sc_lv<1>(in1b_V_V_dout.read() == ap_const_lv11_401);
}
...
void combinar::thread_in1b_V_V_read_nbread_fu_50_p2_0() {
    in1b_V_V_read_nbread_fu_50_p2_0 =  (sc_lv<1>) ((in1b_V_V_empty_n.read()));
}
...
void combinar::thread_in2b_V_V_read_nbread_fu_56_p2_0() {
    in2b_V_V_read_nbread_fu_56_p2_0 =  (sc_lv<1>) ((in2b_V_V_empty_n.read()));
}
...
void combinar::thread_result_V_V_blk_n() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
          ...
          esl_seteq<1,1,1>(empty_n_reg_144.read(), ap_const_lv1_1) && 
          esl_seteq<1,1,1>(icmp_ln879_reg_162.read(), ap_const_lv1_0)) || 
         (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
          esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
          esl_seteq<1,1,1>(ap_block_pp0_stage0.read(), ap_const_boolean_0) && 
          esl_seteq<1,1,1>(ap_const_lv1_1, empty_n_1_reg_153.read()) && 
          esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln879_1_reg_166.read())) || 
...
void combinar::thread_result_V_V_din() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && 
        ...
        result_V_V_din = tmp_V_2_reg_157.read();
        ...
        result_V_V_din = tmp_V_reg_148.read();
    } else {
