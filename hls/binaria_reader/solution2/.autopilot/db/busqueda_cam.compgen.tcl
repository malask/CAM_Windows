...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_in2_V_V \
    op interface \
    ports { in2_V_V_dout { I 24 vector } in2_V_V_empty_n { I 1 bit } in2_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in2b_V_V_din { O 11 vector } in2b_V_V_full_n { I 1 bit } in2b_V_V_write { O 1 bit } } \
} "
}
