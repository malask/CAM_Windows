...
module AESL_autofifo_result_V_V (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.top_function.autotvin_result_V_V.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.top_function.autotvout_result_V_V.dat";

//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 11;
