...
set C_modelName {busqueda_cam.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ tree_V int 24 regular {array 512 { 1 1 } 1 1 }  }
	{ nodo_V int 11 regular {fifo 0}  }
	{ relationship_V int 2 regular {fifo 0}  }
	{ fatherSearch int 1 regular {fifo 0}  }
	{ in1_V_V int 11 regular {fifo 1 volatile } {global 1}  }
	{ in1b_V_V int 11 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "tree_V", "interface" : "memory", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "in1_V_V", "interface" : "fifo", "bitwidth" : 11, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "in1b_V_V", "interface" : "fifo", "bitwidth" : 11, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ tree_V_address0 sc_out sc_lv 9 signal 0 } 
	{ tree_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ tree_V_q0 sc_in sc_lv 24 signal 0 } 
	{ tree_V_address1 sc_out sc_lv 9 signal 0 } 
	...
	{ relationship_V_dout sc_in sc_lv 2 signal 2 } 
	{ relationship_V_empty_n sc_in sc_logic 1 signal 2 } 
	{ relationship_V_read sc_out sc_logic 1 signal 2 } 
	{ fatherSearch_dout sc_in sc_lv 1 signal 3 } 
	{ fatherSearch_empty_n sc_in sc_logic 1 signal 3 } 
	{ fatherSearch_read sc_out sc_logic 1 signal 3 } 
	{ in1_V_V_din sc_out sc_lv 11 signal 4 } 
	{ in1_V_V_full_n sc_in sc_logic 1 signal 4 } 
	{ in1_V_V_write sc_out sc_logic 1 signal 4 } 
	{ in1b_V_V_din sc_out sc_lv 11 signal 5 } 
	{ in1b_V_V_full_n sc_in sc_logic 1 signal 5 } 
	{ in1b_V_V_write sc_out sc_logic 1 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tree_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "tree_V", "role": "address0" }} , 
 	...
 	{ "name": "tree_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "tree_V", "role": "address1" }} , 
 	...
 	{ "name": "in1_V_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "in1_V_V", "role": "din" }} , 
 	...
 	{ "name": "in1b_V_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "in1b_V_V", "role": "din" }} , 
 	{ "name": "in1b_V_V_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in1b_V_V", "role": "full_n" }} , 
 	{ "name": "in1b_V_V_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in1b_V_V", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "in1b_V_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	tree_V { ap_memory {  { tree_V_address0 mem_address 1 9 }  { tree_V_ce0 mem_ce 1 1 }  { tree_V_q0 mem_dout 0 24 }  { tree_V_address1 MemPortADDR2 1 9 }  { tree_V_ce1 MemPortCE2 1 1 }  { tree_V_q1 MemPortDOUT2 0 24 } } }
	...
	in1_V_V { ap_fifo {  { in1_V_V_din fifo_data 1 11 }  { in1_V_V_full_n fifo_status 0 1 }  { in1_V_V_write fifo_update 1 1 } } }
	in1b_V_V { ap_fifo {  { in1b_V_V_din fifo_data 1 11 }  { in1b_V_V_full_n fifo_status 0 1 }  { in1b_V_V_write fifo_update 1 1 } } }
}
