...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename tree_V \
    op interface \
    ports { tree_V_address0 { O 9 vector } tree_V_ce0 { O 1 bit } tree_V_q0 { I 24 vector } tree_V_address1 { O 9 vector } tree_V_ce1 { O 1 bit } tree_V_q1 { I 24 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_in1_V_V \
    op interface \
    ports { in1_V_V_din { O 11 vector } in1_V_V_full_n { I 1 bit } in1_V_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in1b_V_V_din { O 11 vector } in1b_V_V_full_n { I 1 bit } in1b_V_V_write { O 1 bit } } \
} "
}
