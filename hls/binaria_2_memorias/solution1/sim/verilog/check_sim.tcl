...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.top_function.autotvin_tree1_V.dat"
         "c.top_function.autotvin_tree2_V.dat"
         "c.top_function.autotvin_nodo_V.dat"
         "c.top_function.autotvin_relationship_V.dat"
         "c.top_function.autotvin_fatherSearch.dat"
         "c.top_function.autotvin_result_V_V.dat"
         "c.top_function.autotvout_result_V_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.top_function.autotvout_result_V_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
