...
#ifndef _top_function_entry43_HH_
#define _top_function_entry43_HH_
...
struct top_function_entry43 : public sc_module {
    ...
    sc_out< sc_lv<2> > relationship_V_out2_din;
    sc_in< sc_logic > relationship_V_out2_full_n;
    sc_out< sc_logic > relationship_V_out2_write;
    sc_out< sc_lv<1> > fatherSearch_out_din;
    sc_in< sc_logic > fatherSearch_out_full_n;
    sc_out< sc_logic > fatherSearch_out_write;
    sc_out< sc_lv<1> > fatherSearch_out3_din;
    sc_in< sc_logic > fatherSearch_out3_full_n;
    sc_out< sc_logic > fatherSearch_out3_write;


    // Module declarations
    top_function_entry43(sc_module_name name);
    SC_HAS_PROCESS(top_function_entry43);
    ...
    sc_signal< sc_logic > relationship_V_out2_blk_n;
    sc_signal< sc_logic > fatherSearch_out_blk_n;
    sc_signal< sc_logic > fatherSearch_out3_blk_n;
    ...
    void thread_fatherSearch_out3_blk_n();
    void thread_fatherSearch_out3_din();
    void thread_fatherSearch_out3_write();
    ...
    void thread_relationship_V_out2_blk_n();
    void thread_relationship_V_out2_din();
    void thread_relationship_V_out2_write();
