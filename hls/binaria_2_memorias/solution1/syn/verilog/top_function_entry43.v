...
module top_function_entry43 (
        ...
        relationship_V_out2_din,
        relationship_V_out2_full_n,
        relationship_V_out2_write,
        fatherSearch_out_din,
        fatherSearch_out_full_n,
        fatherSearch_out_write,
        fatherSearch_out3_din,
        fatherSearch_out3_full_n,
        fatherSearch_out3_write
);
...
output  [1:0] relationship_V_out2_din;
input   relationship_V_out2_full_n;
output   relationship_V_out2_write;
output  [0:0] fatherSearch_out_din;
input   fatherSearch_out_full_n;
output   fatherSearch_out_write;
output  [0:0] fatherSearch_out3_din;
input   fatherSearch_out3_full_n;
output   fatherSearch_out3_write;
...
reg relationship_V_out2_write;
reg fatherSearch_out_write;
reg fatherSearch_out3_write;
...
reg    relationship_V_out2_blk_n;
reg    fatherSearch_out_blk_n;
reg    fatherSearch_out3_blk_n;
reg    ap_block_state1;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start == 1'b0) | (fatherSearch_out3_full_n == 1'b0) | (fatherSearch_out_full_n == 1'b0) | (relationship_V_out2_full_n == 1'b0) | (relationship_V_out_full_n == 1'b0) | (nodo_V_out1_full_n == 1'b0) | (nodo_V_out_full_n == 1'b0) | (fatherSearch_empty_n == 1'b0) | (relationship_V_empty_n == 1'b0) | (nodo_V_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (fatherSearch_out3_full_n == 1'b0) | (fatherSearch_out_full_n == 1'b0) | (relationship_V_out2_full_n == 1'b0) | (relationship_V_out_full_n == 1'b0) | (nodo_V_out1_full_n == 1'b0) | (nodo_V_out_full_n == 1'b0) | (fatherSearch_empty_n == 1'b0) | (relationship_V_empty_n == 1'b0) | (nodo_V_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        fatherSearch_out3_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((ap_start == 1'b0) | (fatherSearch_out3_full_n == 1'b0) | (fatherSearch_out_full_n == 1'b0) | (relationship_V_out2_full_n == 1'b0) | (relationship_V_out_full_n == 1'b0) | (nodo_V_out1_full_n == 1'b0) | (nodo_V_out_full_n == 1'b0) | (fatherSearch_empty_n == 1'b0) | (relationship_V_empty_n == 1'b0) | (nodo_V_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        fatherSearch_out3_write = 1'b1;
    end else begin
        fatherSearch_out3_write = 1'b0;
    end
end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        relationship_V_out2_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((ap_start == 1'b0) | (fatherSearch_out3_full_n == 1'b0) | (fatherSearch_out_full_n == 1'b0) | (relationship_V_out2_full_n == 1'b0) | (relationship_V_out_full_n == 1'b0) | (nodo_V_out1_full_n == 1'b0) | (nodo_V_out_full_n == 1'b0) | (fatherSearch_empty_n == 1'b0) | (relationship_V_empty_n == 1'b0) | (nodo_V_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        relationship_V_out2_write = 1'b1;
    end else begin
        relationship_V_out2_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (fatherSearch_out3_full_n == 1'b0) | (fatherSearch_out_full_n == 1'b0) | (relationship_V_out2_full_n == 1'b0) | (relationship_V_out_full_n == 1'b0) | (nodo_V_out1_full_n == 1'b0) | (nodo_V_out_full_n == 1'b0) | (fatherSearch_empty_n == 1'b0) | (relationship_V_empty_n == 1'b0) | (nodo_V_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign fatherSearch_out3_din = fatherSearch_dout;
...
assign relationship_V_out2_din = relationship_V_dout;

assign relationship_V_out_din = relationship_V_dout;

endmodule //top_function_entry43
