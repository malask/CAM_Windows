...
port (
    tree1_V_address0 : OUT STD_LOGIC_VECTOR (8 downto 0);
    tree1_V_ce0 : OUT STD_LOGIC;
    tree1_V_d0 : OUT STD_LOGIC_VECTOR (23 downto 0);
    tree1_V_q0 : IN STD_LOGIC_VECTOR (23 downto 0);
    tree1_V_we0 : OUT STD_LOGIC;
    tree1_V_address1 : OUT STD_LOGIC_VECTOR (8 downto 0);
    tree1_V_ce1 : OUT STD_LOGIC;
    tree1_V_d1 : OUT STD_LOGIC_VECTOR (23 downto 0);
    tree1_V_q1 : IN STD_LOGIC_VECTOR (23 downto 0);
    tree1_V_we1 : OUT STD_LOGIC;
    tree2_V_address0 : OUT STD_LOGIC_VECTOR (9 downto 0);
    tree2_V_ce0 : OUT STD_LOGIC;
    tree2_V_d0 : OUT STD_LOGIC_VECTOR (23 downto 0);
    tree2_V_q0 : IN STD_LOGIC_VECTOR (23 downto 0);
    tree2_V_we0 : OUT STD_LOGIC;
    tree2_V_address1 : OUT STD_LOGIC_VECTOR (9 downto 0);
    tree2_V_ce1 : OUT STD_LOGIC;
    tree2_V_d1 : OUT STD_LOGIC_VECTOR (23 downto 0);
    tree2_V_q1 : IN STD_LOGIC_VECTOR (23 downto 0);
    tree2_V_we1 : OUT STD_LOGIC;
...
architecture behav of top_function is 
    ...
    "top_function,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.470250,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=336,HLS_SYN_LUT=1465,HLS_VERSION=2019_1}";
    ...
    signal top_function_entry3_U0_start_out : STD_LOGIC;
    ...
    signal top_function_entry43_U0_ap_start : STD_LOGIC;
    signal top_function_entry43_U0_ap_done : STD_LOGIC;
    signal top_function_entry43_U0_ap_continue : STD_LOGIC;
    signal top_function_entry43_U0_ap_idle : STD_LOGIC;
    signal top_function_entry43_U0_ap_ready : STD_LOGIC;
    signal top_function_entry43_U0_nodo_V_read : STD_LOGIC;
    signal top_function_entry43_U0_relationship_V_read : STD_LOGIC;
    signal top_function_entry43_U0_fatherSearch_read : STD_LOGIC;
    signal top_function_entry43_U0_nodo_V_out_din : STD_LOGIC_VECTOR (10 downto 0);
    signal top_function_entry43_U0_nodo_V_out_write : STD_LOGIC;
    signal top_function_entry43_U0_nodo_V_out1_din : STD_LOGIC_VECTOR (10 downto 0);
    signal top_function_entry43_U0_nodo_V_out1_write : STD_LOGIC;
    signal top_function_entry43_U0_relationship_V_out_din : STD_LOGIC_VECTOR (1 downto 0);
    signal top_function_entry43_U0_relationship_V_out_write : STD_LOGIC;
    signal top_function_entry43_U0_relationship_V_out2_din : STD_LOGIC_VECTOR (1 downto 0);
    signal top_function_entry43_U0_relationship_V_out2_write : STD_LOGIC;
    signal top_function_entry43_U0_fatherSearch_out_din : STD_LOGIC_VECTOR (0 downto 0);
    signal top_function_entry43_U0_fatherSearch_out_write : STD_LOGIC;
    signal top_function_entry43_U0_fatherSearch_out3_din : STD_LOGIC_VECTOR (0 downto 0);
    signal top_function_entry43_U0_fatherSearch_out3_write : STD_LOGIC;
    signal busqueda_cam_1_U0_ap_start : STD_LOGIC;
    signal busqueda_cam_1_U0_ap_done : STD_LOGIC;
    signal busqueda_cam_1_U0_ap_continue : STD_LOGIC;
    signal busqueda_cam_1_U0_ap_idle : STD_LOGIC;
    signal busqueda_cam_1_U0_ap_ready : STD_LOGIC;
    signal busqueda_cam_1_U0_start_out : STD_LOGIC;
    signal busqueda_cam_1_U0_start_write : STD_LOGIC;
    signal busqueda_cam_1_U0_tree_V_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal busqueda_cam_1_U0_tree_V_ce0 : STD_LOGIC;
    signal busqueda_cam_1_U0_tree_V_address1 : STD_LOGIC_VECTOR (8 downto 0);
    signal busqueda_cam_1_U0_tree_V_ce1 : STD_LOGIC;
    signal busqueda_cam_1_U0_nodo_V_read : STD_LOGIC;
    signal busqueda_cam_1_U0_relationship_V_read : STD_LOGIC;
    signal busqueda_cam_1_U0_fatherSearch_read : STD_LOGIC;
    signal busqueda_cam_1_U0_in1_V_V_din : STD_LOGIC_VECTOR (10 downto 0);
    signal busqueda_cam_1_U0_in1_V_V_write : STD_LOGIC;
    signal busqueda_cam_1_U0_in1b_V_V_din : STD_LOGIC_VECTOR (10 downto 0);
    signal busqueda_cam_1_U0_in1b_V_V_write : STD_LOGIC;
    ...
    signal busqueda_cam_U0_tree_V_address1 : STD_LOGIC_VECTOR (9 downto 0);
    signal busqueda_cam_U0_tree_V_ce1 : STD_LOGIC;
    ...
    signal busqueda_cam_U0_in2_V_V_din : STD_LOGIC_VECTOR (10 downto 0);
    signal busqueda_cam_U0_in2_V_V_write : STD_LOGIC;
    ...
    signal combinar_U0_in1_V_V_read : STD_LOGIC;
    signal combinar_U0_in2_V_V_read : STD_LOGIC;
    ...
    signal nodo_V_c7_full_n : STD_LOGIC;
    signal nodo_V_c7_dout : STD_LOGIC_VECTOR (10 downto 0);
    signal nodo_V_c7_empty_n : STD_LOGIC;
    ...
    signal relationship_V_c8_full_n : STD_LOGIC;
    signal relationship_V_c8_dout : STD_LOGIC_VECTOR (1 downto 0);
    signal relationship_V_c8_empty_n : STD_LOGIC;
    ...
    signal fatherSearch_c9_full_n : STD_LOGIC;
    signal fatherSearch_c9_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal fatherSearch_c9_empty_n : STD_LOGIC;
    signal in1_V_V_full_n : STD_LOGIC;
    signal in1_V_V_dout : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal in2_V_V_dout : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal ap_sync_reg_busqueda_cam_1_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_busqueda_cam_1_U0_ap_ready : STD_LOGIC;
    signal busqueda_cam_1_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal ap_sync_reg_busqueda_cam_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_busqueda_cam_U0_ap_ready : STD_LOGIC;
    signal busqueda_cam_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal start_for_top_function_entry43_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_top_function_entry43_U0_full_n : STD_LOGIC;
    signal start_for_top_function_entry43_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_top_function_entry43_U0_empty_n : STD_LOGIC;
    signal top_function_entry43_U0_start_full_n : STD_LOGIC;
    signal top_function_entry43_U0_start_write : STD_LOGIC;
    ...
    component top_function_entry43 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component start_for_top_funbkb IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_combinacud IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    top_function_entry43_U0 : component top_function_entry43
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    busqueda_cam_1_U0 : component busqueda_cam_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    nodo_V_c7_U : component fifo_w11_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    relationship_V_c8_U : component fifo_w2_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    fatherSearch_c9_U : component fifo_w1_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    in1_V_V_U : component fifo_w11_d8_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    in2_V_V_U : component fifo_w11_d8_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_top_funbkb_U : component start_for_top_funbkb
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_combinacud_U : component start_for_combinacud
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_busqueda_cam_1_U0_ap_ready_assign_proc : process(ap_clk)
    begin
    ...
    ap_sync_reg_busqueda_cam_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
    ...
    busqueda_cam_1_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_sync_ready = ap_const_logic_1) and (busqueda_cam_1_U0_ap_ready = ap_const_logic_0))) then 
                busqueda_cam_1_U0_ap_ready_count <= std_logic_vector(unsigned(busqueda_cam_1_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((busqueda_cam_1_U0_ap_ready = ap_const_logic_1) and (ap_sync_ready = ap_const_logic_0))) then 
                busqueda_cam_1_U0_ap_ready_count <= std_logic_vector(unsigned(busqueda_cam_1_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;

    busqueda_cam_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_sync_ready = ap_const_logic_1) and (busqueda_cam_U0_ap_ready = ap_const_logic_0))) then 
                busqueda_cam_U0_ap_ready_count <= std_logic_vector(unsigned(busqueda_cam_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((busqueda_cam_U0_ap_ready = ap_const_logic_1) and (ap_sync_ready = ap_const_logic_0))) then 
                busqueda_cam_U0_ap_ready_count <= std_logic_vector(unsigned(busqueda_cam_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((top_function_entry3_U0_ap_ready = ap_const_logic_1) and (ap_sync_ready = ap_const_logic_0))) then 
                top_function_entry3_U0_ap_ready_count <= std_logic_vector(unsigned(top_function_entry3_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ap_done <= combinar_U0_ap_done;
    ap_idle <= (top_function_entry43_U0_ap_idle and top_function_entry3_U0_ap_idle and combinar_U0_ap_idle and busqueda_cam_U0_ap_idle and busqueda_cam_1_U0_ap_idle);
    ap_ready <= ap_sync_ready;
    ap_sync_busqueda_cam_1_U0_ap_ready <= (busqueda_cam_1_U0_ap_ready or ap_sync_reg_busqueda_cam_1_U0_ap_ready);
    ap_sync_busqueda_cam_U0_ap_ready <= (busqueda_cam_U0_ap_ready or ap_sync_reg_busqueda_cam_U0_ap_ready);
    ap_sync_continue <= ap_const_logic_1;
    ap_sync_done <= combinar_U0_ap_done;
    ap_sync_ready <= (ap_sync_top_function_entry3_U0_ap_ready and ap_sync_busqueda_cam_U0_ap_ready and ap_sync_busqueda_cam_1_U0_ap_ready);
    ...
    busqueda_cam_1_U0_ap_start <= ((ap_sync_reg_busqueda_cam_1_U0_ap_ready xor ap_const_logic_1) and ap_start);
    busqueda_cam_U0_ap_continue <= ap_const_logic_1;
    busqueda_cam_U0_ap_start <= ((ap_sync_reg_busqueda_cam_U0_ap_ready xor ap_const_logic_1) and ap_start);
    ...
    start_for_top_function_entry43_U0_din <= (0=>ap_const_logic_1, others=>'-');
    ...
    top_function_entry43_U0_ap_start <= start_for_top_function_entry43_U0_empty_n;
    top_function_entry43_U0_start_full_n <= ap_const_logic_1;
    top_function_entry43_U0_start_write <= ap_const_logic_0;
    tree1_V_address0 <= busqueda_cam_1_U0_tree_V_address0;
    tree1_V_address1 <= busqueda_cam_1_U0_tree_V_address1;
    tree1_V_ce0 <= busqueda_cam_1_U0_tree_V_ce0;
    tree1_V_ce1 <= busqueda_cam_1_U0_tree_V_ce1;
    tree1_V_d0 <= ap_const_lv24_0;
    tree1_V_d1 <= ap_const_lv24_0;
    tree1_V_we0 <= ap_const_logic_0;
    tree1_V_we1 <= ap_const_logic_0;
    tree2_V_address0 <= busqueda_cam_U0_tree_V_address0;
    tree2_V_address1 <= busqueda_cam_U0_tree_V_address1;
    tree2_V_ce0 <= busqueda_cam_U0_tree_V_ce0;
    tree2_V_ce1 <= busqueda_cam_U0_tree_V_ce1;
