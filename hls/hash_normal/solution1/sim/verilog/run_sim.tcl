...
if {[file isfile top_function.autotvin.dat]} {
	file delete -force top_function.autotvin.dat
}

if {[file isfile top_function.autotvout.dat]} {
	file delete -force top_function.autotvout.dat
}
