...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'd1 == and_ln109_fu_122_p2) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
...
assign and_ln109_fu_122_p2 = (end_1_2_i_fu_44 & end_0_2_i_fu_40);
