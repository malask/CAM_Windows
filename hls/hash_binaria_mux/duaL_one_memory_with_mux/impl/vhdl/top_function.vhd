...
architecture behav of top_function is 
    ...
    "top_function,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=6.888000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=114,HLS_SYN_LUT=595,HLS_VERSION=2019_1}";
    ...
    signal busqueda_cam_U0_start_out : STD_LOGIC;
    ...
    signal busqueda_cam_U0_in1_V_V_din : STD_LOGIC_VECTOR (10 downto 0);
    signal busqueda_cam_U0_in1_V_V_write : STD_LOGIC;
    ...
    component start_for_combinabkb IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        start_out => busqueda_cam_U0_start_out,
        start_write => busqueda_cam_U0_start_write,
        ...
        in1_V_V_din => busqueda_cam_U0_in1_V_V_din,
        in1_V_V_full_n => in1_V_V_full_n,
        in1_V_V_write => busqueda_cam_U0_in1_V_V_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => busqueda_cam_U0_in1_V_V_din,
        if_full_n => in1_V_V_full_n,
        if_write => busqueda_cam_U0_in1_V_V_write,
    ...
    start_for_combinabkb_U : component start_for_combinabkb
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        ...
        if_write => busqueda_cam_U0_start_write,
    ...
    ap_done <= combinar_U0_ap_done;
    ap_idle <= (top_function_entry3_U0_ap_idle and combinar_U0_ap_idle and busqueda_cam_U0_ap_idle);
    ...
    ap_sync_ready <= (ap_sync_top_function_entry3_U0_ap_ready and ap_sync_busqueda_cam_U0_ap_ready);
