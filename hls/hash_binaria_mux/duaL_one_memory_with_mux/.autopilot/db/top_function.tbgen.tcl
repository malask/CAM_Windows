...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8", "9"],
		...
		"InputProcess" : [
			...
			{"ID" : "2", "Name" : "busqueda_cam_U0", "ReadyCount" : "busqueda_cam_U0_ap_ready_count"}],
		"OutputProcess" : [
			{"ID" : "3", "Name" : "combinar_U0"}],
		"Port" : [
			{"Name" : "tree_V", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "busqueda_cam_U0", "Port" : "tree_V"}]},
			...
			{"Name" : "result_V_V", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "combinar_U0", "Port" : "result_V_V"}]},
			{"Name" : "in1_V_V", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "busqueda_cam_U0", "Port" : "in1_V_V"},
					{"ID" : "3", "SubInstance" : "combinar_U0", "Port" : "in1_V_V"}]},
			{"Name" : "in2_V_V", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "busqueda_cam_U0", "Port" : "in2_V_V"},
					{"ID" : "3", "SubInstance" : "combinar_U0", "Port" : "in2_V_V"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.top_function_entry3_U0", "Parent" : "0",
		...
		"Port" : [
			...
			{"Name" : "relationship_V", "Type" : "None", "Direction" : "I"},
			{"Name" : "fatherSearch", "Type" : "None", "Direction" : "I"},
			{"Name" : "nodo_V_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "2", "DependentChan" : "4",
				"BlockSignal" : [
					{"Name" : "nodo_V_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "relationship_V_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "2", "DependentChan" : "5",
				"BlockSignal" : [
					{"Name" : "relationship_V_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "fatherSearch_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "2", "DependentChan" : "6",
				"BlockSignal" : [
					{"Name" : "fatherSearch_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.busqueda_cam_U0", "Parent" : "0",
		"CDFG" : "busqueda_cam",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "tree_V", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "nodo_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "1", "DependentChan" : "4",
				"BlockSignal" : [
					{"Name" : "nodo_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "relationship_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "1", "DependentChan" : "5",
				"BlockSignal" : [
					{"Name" : "relationship_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "fatherSearch", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "1", "DependentChan" : "6",
				"BlockSignal" : [
					{"Name" : "fatherSearch_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "in1_V_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "3", "DependentChan" : "7",
				"BlockSignal" : [
					{"Name" : "in1_V_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "in2_V_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "3", "DependentChan" : "8",
				"BlockSignal" : [
					{"Name" : "in2_V_V_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.combinar_U0", "Parent" : "0",
		"CDFG" : "combinar",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"StartSource" : "2",
		"StartFifo" : "start_for_combinabkb_U",
		"Port" : [
			{"Name" : "result_V_V", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "result_V_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "in1_V_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "2", "DependentChan" : "7"},
			{"Name" : "in2_V_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "2", "DependentChan" : "8"}]},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.nodo_V_c_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.relationship_V_c_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fatherSearch_c_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.in1_V_V_U", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.in2_V_V_U", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_combinabkb_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	...
	busqueda_cam {
		...
		in1_V_V {Type O LastRead -1 FirstWrite 2}
		in2_V_V {Type O LastRead -1 FirstWrite 2}}
	combinar {
		result_V_V {Type O LastRead -1 FirstWrite 2}
