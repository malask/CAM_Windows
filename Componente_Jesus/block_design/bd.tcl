...
xilinx.com:hls:scone_engine:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: scone_engine_0, and set properties
  set scone_engine_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:scone_engine:1.0 scone_engine_0 ]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins scone_engine_0/s_axi_CONTROL_BUS]
  ...
  connect_bd_net -net axis_dwidth_converter_0_s_axis_tready [get_bd_pins axis_dwidth_converter_0/s_axis_tready] [get_bd_pins scone_engine_0/path_V_V_full_n]
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_pins blk_mem_gen_0/douta] [get_bd_pins scone_engine_0/marks_V_q0]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins scone_engine_0/ap_rst_n]
  connect_bd_net -net scone_engine_0_interrupt [get_bd_pins scone_engine_0/interrupt] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net scone_engine_0_marks_V_address0 [get_bd_pins blk_mem_gen_0/addra] [get_bd_pins scone_engine_0/marks_V_address0]
  connect_bd_net -net scone_engine_0_marks_V_ce0 [get_bd_pins blk_mem_gen_0/ena] [get_bd_pins scone_engine_0/marks_V_ce0]
  connect_bd_net -net scone_engine_0_marks_V_d0 [get_bd_pins blk_mem_gen_0/dina] [get_bd_pins scone_engine_0/marks_V_d0]
  connect_bd_net -net scone_engine_0_marks_V_we0 [get_bd_pins blk_mem_gen_0/wea] [get_bd_pins scone_engine_0/marks_V_we0]
  connect_bd_net -net scone_engine_0_path_V_V_din [get_bd_pins axis_dwidth_converter_0/s_axis_tdata] [get_bd_pins scone_engine_0/path_V_V_din]
  connect_bd_net -net scone_engine_0_path_V_V_write [get_bd_pins axis_dwidth_converter_0/s_axis_tvalid] [get_bd_pins scone_engine_0/path_V_V_write]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins scone_engine_0/ap_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs scone_engine_0/s_axi_CONTROL_BUS/Reg] -force
