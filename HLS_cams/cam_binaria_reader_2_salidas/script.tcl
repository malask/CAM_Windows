...
set name "cam_binaria_reader_2_salidas"
set cam "cam.cpp"
set cust_cam "cam.h"
...
foreach i $tamanos {
	...
	add_files ./HLS_cams/cam_binaria_reader_2_salidas/cam.cpp -cflags $short_flag
	add_files ./HLS_cams/cam_binaria_reader_2_salidas/cam.h -cflags $short_flag
	add_files $fullDatFile
	add_files $fullResFile
	add_files -tb ./HLS_cams/cam_binaria_reader_2_salidas/test_bench.cpp -cflags $long_flag -csimflags "-Wno-unknown-pragmas"
