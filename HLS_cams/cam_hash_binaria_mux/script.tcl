...
foreach i $tamanos {
	...
	add_files ./HLS_cams/cam_hash_binaria_mux/cam.cpp -cflags $short_flag
	add_files ./HLS_cams/cam_hash_binaria_mux/cam.h -cflags $short_flag
	add_files $fullDatFile
	add_files -tb $fullResFile
	add_files -tb ./HLS_cams/cam_hash_binaria_mux/test_bench.cpp -cflags $long_flag -csimflags "-Wno-unknown-pragmas"
