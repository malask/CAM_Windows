...
#include "cam.h"
 ...
 #pragma HLS DATAFLOW
 	busqueda_cam(tree1, true, nodo, relationship, fatherSearch, in1,in1b);
 	busqueda_cam(tree2, false, nodo, relationship, fatherSearch, in2,in2b);
 	combinar(in1,in2,in1b,in2b,result);
 }
 void busqueda_cam (edge_t tree [TREE_SIZE], bool number, node_t nodo, rel_t relationship, bool fatherSearch, hls::stream<node_t> &result1,hls::stream<node_t> &result2) {
