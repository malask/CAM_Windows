...
foreach i $tamanos {
	...
	add_files ./HLS_cams/cam_binaria_reader/cam.cpp -cflags $short_flag
	add_files ./HLS_cams/cam_binaria_reader/cam.h -cflags $short_flag
	add_files $fullDatFile
	add_files $fullResFile
	add_files -tb ./HLS_cams/cam_binaria_reader/test_bench.cpp -cflags $long_flag -csimflags "-Wno-unknown-pragmas"
