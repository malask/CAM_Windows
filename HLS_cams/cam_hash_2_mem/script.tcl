...
foreach i $tamanos {
	...
	add_files ./HLS_cams/cam_hash_2_mem/cam.cpp -cflags $short_flag
	add_files ./HLS_cams/cam_hash_2_mem/cam.h -cflags $short_flag
	add_files $fullDatFile
	add_files -tb $fullResFile
	add_files -tb ./HLS_cams/cam_hash/test_bench.cpp -cflags $long_flag -csimflags "-Wno-unknown-pragmas"
