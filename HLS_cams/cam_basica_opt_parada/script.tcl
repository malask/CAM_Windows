...
set name "cam_basica_opt_parada"
set cam "cam.cpp"
set cust_cam "cam.h"
...
foreach i $tamanos {
	...
	add_files ./HLS_cams/cam_basica_opt_parada/cam.cpp -cflags $short_flag
	add_files ./HLS_cams/cam_basica_opt_parada/cam.h -cflags $short_flag
	add_files $fullDatFile
	add_files -tb $fullResFile
	add_files -tb ./HLS_cams/cam_basica_opt_parada/test_bench.cpp -cflags $long_flag -csimflags "-Wno-unknown-pragmas"
